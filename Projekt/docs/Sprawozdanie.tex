...
\begin{figure}[H]
    ...
    \begin{adjustbox}{width=1.1\textwidth,center}
        \subfloat[Schemat układu]{
            \includegraphics[width=\textwidth]{../LTSpice/Digital/schematic.png}
            \label{fig:subfig1}
        }
        \qquad
        \subfloat[Przebiegi czasowe prądu i napięcia na wyjściu układu]{
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[color=green] table {../LTSpice/Digital/traces/vout/segment_1.csv};
                    \addplot[color=green] table {../LTSpice/Digital/traces/vout/segment_2.csv};
                ...
                \begin{axis}[
                    ...
                    \addplot[color=red] table {../LTSpice/Digital/traces/iout/segment_1.csv};
                    \addplot[color=red] table {../LTSpice/Digital/traces/iout/segment_2.csv};
