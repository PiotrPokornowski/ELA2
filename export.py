...
# Example usage:
input_file = './Projekt/LTSpice/Analog_3/iout.txt'  # Replace 'input.csv' with your input file name
output_dir = './Projekt/docs/figures/Analog_3/iout/'    # Replace 'segments' with your desired output directory name
